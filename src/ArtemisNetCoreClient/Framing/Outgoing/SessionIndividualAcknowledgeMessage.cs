...
internal readonly struct SessionIndividualAcknowledgeMessage : IOutgoingPacket
{
    public PacketType PacketType => PacketType.SessionIndividualAcknowledgeMessage;
